...
function azx() {
    ...
    local SELECTED_SUBSCRIPTION=$(__xx_construct_azure_accounts | fzf --exact --ansi --header-lines=1 --info=inline \
        ...
        --layout=reverse-list \
        --border-label ' Azure Subscriptions ' --color 'border:#74c7ec,label:#74c7ec,header:#74c7ec:bold,header:#74c7ec' \
        --header 'CTRL-O: Open Azure Portal | CTRL+U: Unset Active Subscription | ENTER: Activate Subscription' \
